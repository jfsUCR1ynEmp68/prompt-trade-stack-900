# prompt-trade-stack-900

AI workflow experiments with reusable commands and prompts.
...
- `z-kiro-accounts 2026-01-03 00-45-29.json`
- `provider_pools.json.example`
- `go.mod`
- `kiro-maggee-20260103.json`
- `stack.go`
- `run-docker.sh`
- `z-kiro-accounts 2026-01-03 00-15-36.json`
- `z-kiro-accounts 2026-01-03 00-41-56.json`
